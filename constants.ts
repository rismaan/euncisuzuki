...
export const WHATSAPP_NUMBER = "6288901338000";
export const WHATSAPP_MESSAGE = "Halo, saya tertarik dengan promo mobil Suzuki dan ingin bertanya lebih lanjut.";
export const PHONE_NUMBER = "6288901338000";
export const EMAIL_ADDRESS = "eunci.suzukibandung@gmail.com";
export const INSTAGRAM_USERNAME = "@eunci.suzukibandung";
export const INSTAGRAM_URL = "https://www.instagram.com/eunci.suzukibandung";
...
export const TESTIMONIALS: Testimonial[] = [
    {
        customerName: 'Ibu Amanda',
        carModel: 'Suzuki Fronx',
        photoUrl: 'https://i.imghippo.com/files/yja6045rc.jpg',
        quote: 'g'
    },
    {
        customerName: 'Ibu Ika',
        carModel: 'Suzuki New Carry',
        photoUrl: 'https://i.imghippo.com/files/JZJn1528iMg.jpg',
        quote: 'g'
    },
    {
        customerName: 'Ibu Fitri',
        carModel: 'Suzuki Fronx',
        photoUrl: 'https://i.imghippo.com/files/iLuC6832kjo.jpg',
        quote: 'g'
    },
    {
        customerName: 'Ibu Marsha',
        carModel: 'Suzuki Jimnny',
        photoUrl: 'https://i.imghippo.com/files/GrIw9212u.jpg',
        quote: 'g'
    },
    {
        customerName: 'Ibu Neli',
        carModel: 'Suzuki Fronx',
        photoUrl: 'https://i.imghippo.com/files/NZ1582Zbw.jpg',
        quote: 'g'
    },
    {
        customerName: 'Ibu Jeany',
        carModel: 'Suzuki XL7',
        photoUrl: 'https://i.imghippo.com/files/FJ5598ZNs.jpg',
        quote: 'g'
    },
    {
        customerName: 'Ibu Retno',
        carModel: 'Suzuki Fronx',
        photoUrl: 'https://i.imghippo.com/files/YZai8984bRk.jpg',
        quote: 'g'
    },
    {
        customerName: 'Pak Ardian',
        carModel: 'Suzuki XL7',
        photoUrl: 'https://i.imghippo.com/files/ePJ5662aI.jpg',
        quote: 'g'
    },
    {
        customerName: 'Pak Rizal',
        carModel: 'Suzuki New Carry',
        photoUrl: 'https://i.imghippo.com/files/ARkg1048Us.jpg',
        quote: 'g'
    },
];
